        ...
        <div className="app">
          ...
          <div className="header">
            ...
            <p>
              ...
              experiences for people. I'm currently pursuing a Bachelors degree
          ...
          <div className="content">
            ...
            <div id="projects_content" className="projects_content">
              <h1>PROJECTS</h1>
              <p>
                A list of recent projects I've been working on like
                apps,websites and design prototypes.
              </p>
              <div className="grouped_projects">
                ...
                <div id="projects" className="projects">
                  ...
                  <p>#react</p>
                  <a
                    href="https://js-unsplash-react.netlify.com/"
                    target="blank"
                  >
                    <img src={Unsplash} />
                  </a>
